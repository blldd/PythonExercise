...
folder_path = './input/'
train_identity = pd.read_csv(open('{}train_identity.csv'.format(folder_path)))
train_transaction = pd.read_csv(open('{}train_transaction.csv'.format(folder_path)))
test_identity = pd.read_csv(open('{}test_identity.csv'.format(folder_path)))
test_transaction = pd.read_csv(open('{}test_transaction.csv'.format(folder_path)))
sub = pd.read_csv(open('{}sample_submission.csv'.format(folder_path)))
