# -*- coding: utf-8 -*-
"""
@Time    : 2019/5/26 18:20 AM
@Author  : ddlee
@File    : section_3_profit_loss.py
"""
import os
import time
...
def process(in_file, sheet_names, last=1):
...
if __name__ == '__main__':
    ...
    process(in_file, sheet_names, last=1)
    # print(get_positive_profit(in_file, sheet_names, last=1))
