# -*- coding: utf-8 -*-
"""
Created on Wed Nov  23 18:28:53 2017
...
if __name__ == '__main__':
    ...
    with open('F:/ECNU/Course/KnowledgeAna/results/C4.5.res', 'a') as res:
        MAE_TOTAL = 0
        for QID in QID_LIST:
            print('C4.5 for query ' + QID)
            ...
            print('predicting...')
            Y_hat = clfDT.predict(X_test)                                                      #predict
