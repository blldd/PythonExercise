# -*- coding: utf-8 -*-
"""
Created on Wed Nov  20 10:39:22 2017
...
if __name__ == '__main__':
    ...
    with open('F:/ECNU/Course/KnowledgeAna/results/LARS.res', 'a') as res:
        MAE_TOTAL = 0
        for QID in QID_LIST:
            print('LARS for query ' + QID)
            ...
            #lars.train(X_train, Y_train, 0.2)                                                        #train
            #call sklearn.LassoLarsCV()
            clflars = LassoLarsCV().fit(X_train, Y_train)
