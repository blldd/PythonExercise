# -*- coding: utf-8 -*-
"""
Created on Wed Nov  20 20:49:26 2017
...
if __name__ == '__main__':
    ...
    with open('F:/ECNU/Course/KnowledgeAna/results/ridgeRe.res', 'a') as res:
        MAE_TOTAL = 0
        for QID in QID_LIST:
            print('RidgeRegre for query ' + QID)
            ridgeRe = RidgeRegre()
            vector = Vector(QID)
            ...
            ridgeRe.train(X_train, Y_train, 0.2)                                                        #train
            ...
            print('predicting...')
            Y_hat = ridgeRe.predict(X_test)                                                      #predict
