...
if __name__ == '__main__':
    ...
    with open('F:/ECNU/Course/KnowledgeAna/results/ElasticNet.res', 'a') as res:
        MAE_TOTAL = 0
        for QID in QID_LIST:
            print('ElasticNet for query ' + QID)
            ...
            #call sklearn.Lasso()
            clfelasticNet = ElasticNet().fit(10000*X_train, Y_train)
            ...
            print('predicting...')
            Y_hat = clfelasticNet.predict(10000*X_test)                                                      #predict
