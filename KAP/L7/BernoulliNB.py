...
if __name__ == '__main__':
    ...
    with open('F:/ECNU/Course/KnowledgeAna/results/Naive.res', 'a') as res:
        MAE_TOTAL = 0
        for QID in QID_LIST:
            print('Naive for query ' + QID)
            ...
            #call sklearn.Lasso()
            clfRand = BernoulliNB(alpha=1.0, binarize=0.0, fit_prior=True, class_prior=None)
